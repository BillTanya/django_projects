...
class Book(models.Model):
    ...
    def authors_of_the_book(self):
        ...
        if len(a) == 1:
            ...
            for i in range(len(self.authors.all())-1):
                authors += repr(a[i])+', '
            authors += repr(a[len(a)-1])
        else:
            authors += 'no author yet'
        return authors
    ...
    def display_authors(self):
        """
                ...
                """
        return ', '.join([repr(author) for author in self.authors.all()[:3]])
    ...
    def get_authors(self):
        ...
        try:
            ...
            if len(authors) == 1:
                ...
                authors = authors[::-1][1:]
            return {'authors': authors, 'last_author': last_author}
        except:
            return {'authors': 0, 'last_author': 0}
