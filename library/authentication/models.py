...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(blank=True, max_length=20, default=None, null=True)
    last_name = models.CharField(blank=True, max_length=20, default=None, null=True)
    middle_name = models.CharField(blank=True, max_length=20, default=None, null=True)
